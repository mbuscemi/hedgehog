pub fn html() -> String {
    format!(
		...
		"#,
        hedgehog_wasm = inline_wasm(include_bytes!("../static/hedgehog-frontend.wasm").to_vec()),
        hedgehog_frontend = inline_script(include_str!("../static/hedgehog-frontend.js").to_string()),
    )
}
