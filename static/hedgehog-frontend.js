...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.hedgehog_frontend = factory();
    }
}( this, function() {
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "hedgehog-frontend.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "hedgehog-frontend.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'hedgehog_frontend'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'hedgehog_frontend':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_652c3349b3924cb8fe3ba21ac13ded747ec42769": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return document.addEventListener("set_file",content=>alert(content));})());
            },
